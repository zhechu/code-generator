...
public class DemoCode {
	...
	public static void main(String[] args) throws IOException, SQLException, TemplateException {
		 ...
		 */
		cfg.setBasePackage("com.anfachina.aflc");

		//模块包,同一模块这个地方不需要修改,，比如系统管理模块，设备管理模块
		cfg.setBizPackage("usercenter");
		//mvc:com.jiesai.framework.controller.iemsuser;
		//要生成的表名称
		cfg.setTable_name("aflc_driver_shipper_log");//aflc_business_group_user aflc_business_group
		//表中文名称
		cfg.setCode_name("车主货主信息修改日志");//车主行为异常记录表 业务分组人员信息 业务分组表
		//在硬盘路径下输出
