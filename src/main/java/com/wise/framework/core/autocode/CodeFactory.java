package com.wise.framework.core.autocode;
...
import com.wise.framework.common.util.Tools;
import com.wise.framework.core.cfg.Frameworkcfg;
import com.wise.framework.core.commom.*;
import com.wise.framework.core.table.GciPropertyTable;
import com.wise.framework.core.table.GciTable;
...
public class CodeFactory {
		...
		public static void codeGenerate(CodeCfg cfg) throws SQLException, IOException, TemplateException{
			...
			if(FrameworkType.ssm.equals(cfg.getFramework_type())){
				...
				if(list.size()>0){
					//生成web先
					cg.setPath(code_package_path+"/web"+"/");
					cg.setTemplete_path("web\\springmvc");
					String springMvcController_File= code_package_path+"/web"+"//"+entityName+"Controller.java";
					...
					//设置主键实体的属性值
					temp.setPkName(pkobj.getJavaColumnFileNameCode());
					m.put("p", temp);
					cg.setDatas(m);
